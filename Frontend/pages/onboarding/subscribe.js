    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="bg-white p-6 rounded-lg shadow-lg w-[28rem]">
        ...
        <p className="text-gray-500 text-center mb-6">
          Our services operate on a monthly subscription model. Choose a plan to start receiving bookings.
        </p>
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <p className="text-sm text-gray-600">Try all features free for 7 days. No credit card required.</p>
          </div>
        ...
        <button
          ...
          className={`w-full py-2 rounded-lg mt-6 text-white transition ${
            selectedPlan ? "bg-black hover:opacity-90" : "bg-gray-400 cursor-not-allowed"
          }`}
        >
          Continue
        </button>
