...
export default function PrivacyPolicy() {
  return (
    <div className="max-w-4xl mx-auto px-6 py-16 text-gray-800">
      ...
      <p className="mb-4">
        You have the right to access, update, or delete your personal information. To make a request, contact us at <a href="mailto:support@glowguide.com" className="text-blue-600 underline">support@glowguide.com</a>.
      </p>
      ...
      <p>
        If you have any questions about this Privacy Policy, please contact us at <a href="mailto:support@glowguide.com" className="text-blue-600 underline">support@glowguide.com</a>.
      </p>
